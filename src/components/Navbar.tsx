    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        <div className="flex items-center space-x-2">
          <Sparkles
            className={`${darkMode ? 'text-purple-400' : 'text-purple-600'} animate-pulse`}
            size={24}
          />
        ...
        <div className="flex items-center space-x-6">
          ...
          <button
            ...
            className={`${activeSection === 'projects' ? (darkMode ? 'text-purple-400' : 'text-purple-600') : darkMode ? 'text-gray-400' : 'text-gray-600'} hover:text-purple-400 transition-colors font-medium`}
          >
            Projects
          </button>
          <button
